...
def create_app(test_config=None):
    ...
    app.config['JWT_ACCESS_TOKEN_EXPIRES'] = td(hours=JWT_ACCESS_TOKEN_EXPIRES)
    app.config['JWT_REFRESH_TOKEN_EXPIRES'] = td(days=JWT_REFRESH_TOKEN_EXPIRES)
    jwt = JWTManager(app)

    # print server configuration
    print(f'{SERVER_FULL_NAME} on port {SERVER_PORT}...')
    print('--')
